...
const Header = ({ activeHeading }) => {
  ...
  const [dropDown, setDrompDown] = useState(false);
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* categories */}
          <div onClick={() => setDrompDown(!dropDown)}>
              ...
              <div className="flex w-full justify-center">
                {isAuthenticated ? (
                    ...
                    <div>
                      <Link to="/profile">
                        <img
                          src={user?.avatar?.url}
                          alt=""
                          className="w-[50px] h-[50px] rounded-full border-[3px] border-[#0ba25c]"
                        />
                      </Link>
                    </div>
                  </>
                  ...
                  <>
                    <Link
                      to="/login"
                      className="text-[16px] pr-[10px] text-[#000000b7]"
                    >
                      Login /
                    </Link>
                    <Link
