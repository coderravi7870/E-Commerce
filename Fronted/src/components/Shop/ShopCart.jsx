...
const ShopCart = () => {
  ...
  const [phoneNumber, setPhoneNumber] = useState("");  // Initialize as string
  const [address, setAddress] = useState("");
  const [zipCode, setZipCode] = useState("");          // Initialize as string
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setPassword("");
        setAvatar(null);
        setZipCode("");           // Reset to empty string
        setPhoneNumber("");       // Reset to empty string
        setAddress("");
      })
      .catch((error) => {
